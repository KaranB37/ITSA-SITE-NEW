...
import pdfFile from "../assets/vision.pdf";
      ...
      <div className="center-vismis">
        ...
        <div className="content-container-vismis">
          ...
          <p className="description-vismis">
            ...
            interaction to enhance career opportunities for the employability of
            students.
          </p>
          <p className="description-vismis">
            To encourage collaborations with industries and academic institutes
            in terms of projects & internships by creating area for Research and
            Development.
          </p>
          <p className="description-vismis">
        ...
        <div className="content-container-vismis">
          ...
          <p className="description-vismis">
            ...
            entrepreneurship, employability and the ability to apply technology
